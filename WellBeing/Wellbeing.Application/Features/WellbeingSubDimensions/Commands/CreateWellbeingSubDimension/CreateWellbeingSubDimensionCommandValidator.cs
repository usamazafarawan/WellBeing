...
public class CreateWellbeingSubDimensionCommandValidator : AbstractValidator<CreateWellbeingSubDimensionCommand>
{
    public CreateWellbeingSubDimensionCommandValidator()
    {
        RuleFor(x => x.Name)
