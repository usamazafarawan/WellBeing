...
public class UpdateWellbeingDimensionCommandValidator : AbstractValidator<UpdateWellbeingDimensionCommand>
{
    public UpdateWellbeingDimensionCommandValidator()
    {
        RuleFor(x => x.Id)
